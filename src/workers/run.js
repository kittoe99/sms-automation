...
const modes={sms:[['sms_send_jobs',processSms]],automation:[['automation_jobs',processAutomation],['provisioning_jobs',processProvisioning]],ai:[['ai_reply_jobs',processAi]]};
