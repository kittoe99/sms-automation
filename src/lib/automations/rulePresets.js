...
export const AUTOMATION_RULE_PRESETS = Object.freeze([
  {
    ...
    rule: {
      cadence: 'custom', intervalCount: 1, intervalUnit: 'day', startHour: 9, endHour: 19, deliveryMode: 'deterministic',
      steps: [
  ...
  },
  {
    ...
    rule: {
      cadence: 'custom', intervalCount: 1, intervalUnit: 'day', startHour: 8, endHour: 20, deliveryMode: 'deterministic',
      steps: [
  ...
  },
  {
    ...
    rule: {
      cadence: 'weekly', intervalCount: 1, intervalUnit: 'week', startHour: 9, endHour: 19, deliveryMode: 'deterministic',
      steps: [
  ...
  },
  {
    ...
    rule: {
      cadence: 'custom', intervalCount: 2, intervalUnit: 'week', startHour: 9, endHour: 19, deliveryMode: 'deterministic',
      steps: [
  ...
  },
  {
    ...
    rule: {
      cadence: 'monthly', intervalCount: 1, intervalUnit: 'month', startHour: 9, endHour: 19, deliveryMode: 'deterministic',
      steps: [
