...
const targets={'sms-worker':'SMS_WORKER_SECRET','automation-worker':'AUTOMATION_WORKER_SECRET','ai-worker':'AI_WORKER_SECRET','provisioning-worker':'PROVISIONING_WORKER_SECRET'};
