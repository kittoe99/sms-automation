...
const {CRM_API_BASE,SUPABASE_URL,SUPABASE_PUBLISHABLE_KEY,PUBLIC_FORM_BASE_URL}=process.env;
...
await writeFile('dist/config.js',`globalThis.SMS_CONFIG=${JSON.stringify({apiBase:CRM_API_BASE,supabaseUrl:SUPABASE_URL,supabasePublishableKey:SUPABASE_PUBLISHABLE_KEY,formApiBase:`${SUPABASE_URL}/functions/v1/web-form`,embedBaseUrl:PUBLIC_FORM_BASE_URL||''})};\n`);
